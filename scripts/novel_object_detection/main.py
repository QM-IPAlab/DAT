...
clip_model, preprocess, text_features, lvis_classes = load_clip_model(lvis_data_split, device,"weights/SigLip/www/finetuned_clip_model_with_wise_ft_dsize_500.pth")
