...
from sg.segment_anything import sam_model_registry
from transformers import AutoTokenizer
from scripts.open_vocab_detection.evaluate_method.utils import article, processed_name
...
def load_clip_model(device, checkpoint_path):
    ...
    if checkpoint_path is not None:
        ...
        print(f"Loaded trained CLIP model from {checkpoint_path}")
