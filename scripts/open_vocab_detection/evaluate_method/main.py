...
from scripts.open_vocab_detection.evaluate_method.load_models import load_fully_supervised_trained_model, load_clip_model, load_sam_model
from scripts.open_vocab_detection.evaluate_method.utils import get_text_prompt_for_g_dino, get_ovd_id_to_coco_id
...
clip_model, preprocess, text_features = load_clip_model(device,"weights/SigLip/www/finetuned_clip_model_with_wise_ft_dsize_500.pth")
