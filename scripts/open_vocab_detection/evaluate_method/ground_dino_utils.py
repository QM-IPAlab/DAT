import numpy as np
import scripts.open_vocab_detection.evaluate_method.transforms as T2
import torch
import cv2

from sklearn.preprocessing import MinMaxScaler
from scripts.open_vocab_detection.evaluate_method.utils import BBoxVisualizer, get_clip_preds
...
from sg.segment_anything.utils.amg import batched_mask_to_box
...
def inference_gdino(model, inputs, text_prompt, param_dict):
    ...
    rcnn_boxes = outputs[0]["instances"].pred_boxes.tensor.to("cpu") 
